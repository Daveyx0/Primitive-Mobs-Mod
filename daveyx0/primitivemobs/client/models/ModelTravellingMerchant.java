package daveyx0.primitivemobs.client.models;
	...
	public class ModelTravellingMerchant extends ModelBase
	{
		//fields
	    ModelRenderer Head;
	    ModelRenderer Body;
	  ...
	  public ModelTravellingMerchant()
	  {
	    textureWidth = 128;
	    textureHeight = 64;
